...
const Login = () => {
  ...
  return (
    <div className="contentImg">
      <div className="lg:px-[100px] lg:py-[200px]">
        <div className="grid grid-cols-1 lg:grid-cols-2 justify-center items-center">
          ...
          <div className="w-full p-8 space-y-3 rounded-xl">
            ...
            >
              ...
              <button className="block w-full p-3 font-semibold text-white text-center rounded-sm bg-[#D1A054]">
                Sign in
              </button>
            </form>
            <div className="flex items-center pt-4 space-x-1">
              <div className="flex-1 h-px sm:w-16 dark:bg-gray-300"></div>
              <p className="px-3 text-sm dark:text-gray-600 font-semibold">
